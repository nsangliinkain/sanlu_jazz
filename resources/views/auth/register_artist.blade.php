...
@section('title', 'Registrazione Artista')

@section('content')
    <div class="max-w-md mx-auto px-4 py-8">
        <h2 class="text-2xl font-semibold text-center mb-6">Registrazione Artista</h2>
        @if(session('error'))
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form method="POST" action="{{ route('register.artist') }}" novalidate>
                @csrf
                <div class="mb-4">
                ...
                <p>Sei un artista? <a href="{{ route('register') }}" class="text-indigo-600 hover:underline">Registrati come spettatore</a></p>
            </form>
        </div>
